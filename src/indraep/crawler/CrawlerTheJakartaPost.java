...
public class CrawlerTheJakartaPost extends WebCrawler {
	...
	public boolean shouldVisit(WebURL url) {
		...
		return !FILTERS.matcher(href).matches() &&
				href.contains("thejakartapost.com/");
	}
	...
	public void visit(Page page) {
		...
		if (url.contains("thejakartapost.com/news/2014/") && page.getParseData() instanceof HtmlParseData
			...
			try {
				out = new PrintStream(new FileOutputStream("dataset/thejakartapost/origin/" + pageNumber + ".HTML"));
				out.print(HTML);
